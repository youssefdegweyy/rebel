                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="left" class="esd-block-text">
                                                                <p style="line-height: 150%; font-size: 14px;">Order
                                                                    delivered to: {{ $order->user->name }}
                                                                    - {{ $order->user->mobile }}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text">
                                                                <p style="font-size: 14px;">
                                                                    Address: {{ $order->address }}, {{ $order->town }}
                                                                    , {{ $order->city->name }}
                                                                    , {{ $order->country }}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text">
                                                                <p style="font-size: 14px;">Estimate arrival date: 3-5
                                                                    working days.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text">
                                                                <p style="font-size: 14px;">Order
                                                                    Price: {{ $order->total }} {{ $order->payment_type == 1 ? 'EGP' : 'Points'}}</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="esd-block-text">
                                                                <p style="font-size: 14px;">Shipping
                                                                    Fees: {{ $order->city->price }} EGP</p>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
